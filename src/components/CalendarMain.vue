  ...
  <div class="calendar-main">
    ...
    <div class="month-terms">
      ...
      <div class="month-terms-list">
        ...
        <div v-if="currentMonthTerms.length === 0" class="no-terms">
          本月无节气
        </div>
      </div>
    </div>
...
const emit = defineEmits(["showTermAnimation", "hideTermAnimation"]);
...
function handleTermClick(term) {
  ...
  showDetail.value = true;
  emit("showTermAnimation", term.name);
}
